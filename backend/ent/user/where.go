...
// Coord applies equality check predicate on the "coord" field. It's identical to CoordEQ.
func Coord(v string) predicate.User {
	return predicate.User(sql.FieldEQ(FieldCoord, v))
}
...
// CoordEQ applies the EQ predicate on the "coord" field.
func CoordEQ(v string) predicate.User {
	return predicate.User(sql.FieldEQ(FieldCoord, v))
}

// CoordNEQ applies the NEQ predicate on the "coord" field.
func CoordNEQ(v string) predicate.User {
	return predicate.User(sql.FieldNEQ(FieldCoord, v))
}

// CoordIn applies the In predicate on the "coord" field.
func CoordIn(vs ...string) predicate.User {
	return predicate.User(sql.FieldIn(FieldCoord, vs...))
}

// CoordNotIn applies the NotIn predicate on the "coord" field.
func CoordNotIn(vs ...string) predicate.User {
	return predicate.User(sql.FieldNotIn(FieldCoord, vs...))
}

// CoordGT applies the GT predicate on the "coord" field.
func CoordGT(v string) predicate.User {
	return predicate.User(sql.FieldGT(FieldCoord, v))
}

// CoordGTE applies the GTE predicate on the "coord" field.
func CoordGTE(v string) predicate.User {
	return predicate.User(sql.FieldGTE(FieldCoord, v))
}

// CoordLT applies the LT predicate on the "coord" field.
func CoordLT(v string) predicate.User {
	return predicate.User(sql.FieldLT(FieldCoord, v))
}

// CoordLTE applies the LTE predicate on the "coord" field.
func CoordLTE(v string) predicate.User {
	return predicate.User(sql.FieldLTE(FieldCoord, v))
}

// CoordContains applies the Contains predicate on the "coord" field.
func CoordContains(v string) predicate.User {
	return predicate.User(sql.FieldContains(FieldCoord, v))
}

// CoordHasPrefix applies the HasPrefix predicate on the "coord" field.
func CoordHasPrefix(v string) predicate.User {
	return predicate.User(sql.FieldHasPrefix(FieldCoord, v))
}

// CoordHasSuffix applies the HasSuffix predicate on the "coord" field.
func CoordHasSuffix(v string) predicate.User {
...
// CoordContainsFold applies the ContainsFold predicate on the "coord" field.
func CoordContainsFold(v string) predicate.User {
	return predicate.User(sql.FieldContainsFold(FieldCoord, v))
}
